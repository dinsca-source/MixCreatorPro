...
class MP3DiagnosticsWinLiveReportTests(unittest.TestCase):
    LEGACY_SUMMARY_HEADERS = [
        ...
        "Anomalie bloccanti",
        "Anomalie ultimo secondo non bloccanti",
    ...
    WINLIVE_HEADERS = [
        ...
        "Stato integrità audio originale",
        "Stato integrità originale",
        "Stato validazione WinLive",
        "Esito combinato",
        ...
        "Canonicalizzazione iterazioni",
        "Canonicalizzazione stabilizzata",
        "Canonicalizzazione ciclo rilevato",
        "Canonicalizzazione ciclo iterazione",
        "Canonicalizzazione hash stati",
        "Canonicalizzazione log modifiche",
        "Prima differenza residua",
    ]
